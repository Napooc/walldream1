...
export const Footer = () => {
  ...
  return <footer className="my-8 px-4 max-w-5xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-start justify-between gap-4 md:gap-10 px-2 md:px-8 flex-1 w-full">
          ...
          <div className="flex flex-col items-start gap-2">
            ...
            <div className="flex gap-3 mt-2">
              <a href="https://web.facebook.com/people/Dom-Icile/61572403380475/?rdid=CalJ82LIKVs3Zi7P&share_url=https%3A%2F%2Fweb.facebook.com%2Fshare%2F1DYMAoop37%2F%3Fwtsid%3Drdr_0v5I6smfcC9eezZjA%26_rdc%3D1%26_rdr" target="_blank" rel="noopener noreferrer" className="rounded-full bg-gray-100 p-2 transition-colors hover:bg-accent hover:text-white" aria-label="Facebook">
                <Facebook className="h-5 w-5 text-gray-700 hover:text-white transition-colors" />
              </a>
              <a href="https://www.instagram.com/walldreamm/?igsh=MTJubWpvNTZtZ3JnNg%3D%3D#" target="_blank" rel="noopener noreferrer" className="rounded-full bg-gray-100 p-2 transition-colors hover:bg-accent hover:text-white" aria-label="Instagram">
                <Instagram className="h-5 w-5 text-gray-700 hover:text-white transition-colors" />
              </a>
              <a href="https://www.tiktok.com/@walldream0?_r=1&_t=ZM-91VeXDc5OzE" target="_blank" rel="noopener noreferrer" className="rounded-full bg-gray-100 p-2 transition-colors hover:bg-accent hover:text-white" aria-label="TikTok">
          ...
          <div className="flex flex-col gap-1 md:gap-4">
            ...
            <div className="flex flex-wrap md:flex-col gap-2 text-sm text-gray-700 items-start">
              ...
              <a href="/cgv" className="text-gray-600 whitespace-nowrap font-medium hover:text-accent transition-colors">
                CGV
              </a>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-1 md:gap-4">
            ...
            <div className="flex flex-col gap-3 text-sm text-gray-700 items-start">
              ...
              <a href="mailto:walldream2025@gmail.com" className="flex items-start gap-3 text-gray-600 hover:text-accent transition-colors font-medium">
